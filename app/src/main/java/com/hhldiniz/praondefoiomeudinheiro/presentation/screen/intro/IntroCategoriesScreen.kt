...
private fun IntroCategoriesContent(
    ...
    Column(
        ...
        Box(
            ...
            HardShadowBox(
                ...
                Box(
                    ...
                    Text(
                        text = stringResource(R.string.intro_categories_title),
        ...
        Text(
            text = stringResource(R.string.intro_categories_instruction),
        ...
        Row(
            ...
            HardShadowBox(
                ...
                TextField(
                    ...
                    singleLine = true,
                    placeholder = { Text(stringResource(R.string.intro_categories_add_placeholder)) },
        ...
        NeoButton(
            ...
            text = stringResource(R.string.intro_categories_btn_continue),
        )
    }
}
