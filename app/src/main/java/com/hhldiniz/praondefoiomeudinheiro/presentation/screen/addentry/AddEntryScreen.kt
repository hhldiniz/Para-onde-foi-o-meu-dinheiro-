        ...
        Column(
            ...
            HardShadowBox(
                ...
                Box(
                    ...
                    Text(
                        text = if (uiState.isSaving) stringResource(R.string.action_saving)
...
private fun DateField(
    ...
    Column {
        Text(
            text = stringResource(R.string.add_entry_field_date),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.Bold,
            color = BrutalBlack,
        )
...
private fun AmountField(
    ...
    Column {
        Text(
            text = stringResource(R.string.add_entry_field_amount),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.Bold,
            color = BrutalBlack,
        )
...
private fun DescriptionField(
    ...
    Column {
        Text(
            text = stringResource(R.string.add_entry_field_description),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.Bold,
            color = BrutalBlack,
        )
...
private fun CategoryDropdown(
    ...
    Column {
        Text(
            text = stringResource(R.string.add_entry_field_category),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.Bold,
            color = BrutalBlack,
        )
...
private fun TypeToggle(
    ...
    Column {
        Text(
            text = stringResource(R.string.add_entry_field_type),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.Bold,
            color = BrutalBlack,
        )
        ...
        Row(
            ...
            HardShadowBox(
                ...
                Box(
                    ...
                    Text(
                        text = stringResource(R.string.entry_type_expense),
            ...
            HardShadowBox(
                ...
                Box(
                    ...
                    Text(
                        text = stringResource(R.string.entry_type_income),
                        style = MaterialTheme.typography.titleSmall,
                        fontWeight = if (!isExpense) FontWeight.Black else FontWeight.Bold,
